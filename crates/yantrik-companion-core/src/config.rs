...
impl LLMConfig {
    ...
    pub fn resolve_api_base_url(&self) -> Option<String> {
        ...
        match self.backend.as_str() {
            ...
            "ollama-cloud" => Some("https://api.ollama.com/v1".to_string()),
            ...
            "google" | "gemini" => Some("https://generativelanguage.googleapis.com/v1beta".to_string()),
            ...
            "sambanova" => Some("https://api.sambanova.ai/v1".to_string()),
            // Aggregators & budget
            ...
            "nanogpt" => Some("https://api.nanogpt.com/v1".to_string()),
            ...
            "baidu" => Some("https://aip.baidubce.com/rpc/2.0/ai_custom/v1".to_string()),
            "zhipu" => Some("https://open.bigmodel.cn/api/paas/v4".to_string()),
            // Explicit / custom
            "api" => None, // must be set explicitly
            _ => None,
        }
    }
}
...
pub struct NativeConfig {
    /// Enable the native mobile WebSocket server.
    #[serde(default)]
    pub enabled: bool,
    /// TCP port to listen on for mobile app connections.
    #[serde(default = "default_native_port")]
    pub port: u16,
    /// Pre-shared auth tokens that mobile clients must present.
    #[serde(default)]
    pub auth_tokens: Vec<String>,
    /// Maximum simultaneous mobile client connections.
    #[serde(default = "default_native_max_clients")]
    pub max_clients: usize,
}

fn default_native_port() -> u16 { 9881 }
fn default_native_max_clients() -> usize { 4 }
...
impl Default for NativeConfig {
    fn default() -> Self {
        Self {
            ...
            auth_tokens: vec![],
            max_clients: default_native_max_clients(),
        }
    }
}
...
fn default_mcp_trust() -> String { "untrusted".to_string() }
